"""
Django settings for schoolEnroll project.
...
SECRET_KEY = 'django-insecure-ws1k8@j&69q9^jfw5^ct%i8!#^nim%m16&_ov%#x7a2s_o#3j-'
...
ROOT_URLCONF = 'schoolEnroll.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "schoolEnroll", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'schoolEnroll.wsgi.application'
